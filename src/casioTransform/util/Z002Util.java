...
public class Z002Util {
	...
	public static String Z002UpdateString (Z002 z2) {
	
	String stmt = "insert into Z002 set "+
			"cashAmount=" + z2.getCashAmount().toString() +  ","
			...
			+"z02date = STR_TO_DATE('" + z2.getZ02date().toString().replaceAll("/","-") + " " + z2.getZ02time().toString() + "' , '%d-%m-%Y %H:%i'),"
			+"z02file='" + z2.getZ02file() +  "',"
			+"z02machine='" + z2.getZ02machine() +  "',"
			+"z02mode='" + z2.getZ02mode() +  "',"
			+"z02model='" + z2.getZ02model() +  "',"
			+"z02report='" + z2.getZ02report() +  "',"
